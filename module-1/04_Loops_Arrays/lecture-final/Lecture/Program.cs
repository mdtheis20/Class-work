...
namespace Lecture
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Print Hello World when is even
            ...
            // Now we have the sum, calculate the average
            double classAverage = sum / (double)scores.Length;

//            Console.WriteLine($"The class average adjusted is {classAverage}");
            Console.WriteLine($"The class average adjusted is {sum / (double)scores.Length}");


            // Find out if there are any perfect scores
