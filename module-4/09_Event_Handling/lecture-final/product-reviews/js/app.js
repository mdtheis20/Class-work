...
function initializePage() {
  ...
  // TODO 02b: Handle the keyup event to determine when the user is done editting. 
  //            If the user pressed Enter, save the desc. If they pressed Esc, quit without saving
  ...
  // Handle keyup and check for Enter or Esc
