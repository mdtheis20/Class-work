...
*/
		function hasTeen(x, y, z) {
			let xIsTeen = x >= 13 && x <= 19;
			let yIsTeen = y >= 13 && y <= 19;
			let zIsTeen = z >= 13 && z <= 19;
			return xIsTeen || yIsTeen || zIsTeen;
...
//rstName, lastName, and age. Populate the properties with your values.
