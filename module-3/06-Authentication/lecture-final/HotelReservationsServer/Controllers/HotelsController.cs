...
{
    // TODO 06: Most methods on this controller require a logged in user, so move the Authorize attribute
    [Route("/")]
    [Authorize]
    [ApiController]
    public class HotelsController : ControllerBase
    {
        ...
        // TODO 07: This is the one method which allows non-logged-in users to access (anonymous access).
        [HttpGet("hotels")]
        [AllowAnonymous]
        ...
        // TODO 05: Now Authorize. This method require a logged in user. Protect this controller and then try to hit it with Postman
        [HttpGet("hotels/{id}")]
        ...
        // TODO 08: You must be an "admin" to delete a reservation
